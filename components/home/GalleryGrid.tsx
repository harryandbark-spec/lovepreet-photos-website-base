...
const FRAMES = [
  {
    ...
    location: 'Surrey, BC',
    img: '/images/gallery-sangeet.png',
    span: 'row-span-2',
  ...
  },
  {
    ...
    location: 'Langley, BC',
    img: '/images/gallery-anand-karaj.png',
    span: '',
  ...
  },
  {
    ...
    img: '/images/gallery-mehndi-portrait.png',
    span: '',
    aspect: 'h-full min-h-[200px]',
  },
  {
    ...
    img: '/images/gallery-reception.png',
    span: 'row-span-2',
    aspect: 'h-full min-h-[420px]',
  },
  {
