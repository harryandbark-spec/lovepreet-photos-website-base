...
export function FaqAccordion() {
  ...
  return (
    <section id="logistics" className="bg-linen py-20 lg:py-28">
            ...
            return (
              <div key={faq.q} className="border-b border-ink/10">
                ...
                >
                  ...
                  <span
                    className={`shrink-0 text-2xl leading-none text-champagne transition-transform duration-300 ${isOpen ? 'rotate-45' : ''}`}
                  >
                    +
                  </span>
                </button>
                ...
                >
                  <div className="overflow-hidden">
                    <p className="pb-6 font-sans text-base leading-relaxed text-ink/70">
                      {faq.a}
                    </p>
                  </div>
                </div>
